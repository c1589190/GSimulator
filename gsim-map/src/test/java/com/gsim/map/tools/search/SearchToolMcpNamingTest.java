...
class SearchToolMcpNamingTest {
    ...
    private static final SearchToolContext CTX = new SearchToolContext(() -> null, null, null);

    private static List<AgentTool> searchTools() {
        return List.of(
                new GsimSearchTool(CTX, null),
                new GsimSearchWorldTool(CTX),
                new GsimapSearchRegionTool(CTX, null),
                new GsimapSearchHexTool(CTX, null),
