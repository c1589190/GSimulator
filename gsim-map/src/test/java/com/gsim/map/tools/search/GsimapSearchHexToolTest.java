...
class GsimapSearchHexToolTest {
    ...
    void setUp() {
        ...
        tool = new GsimapSearchHexTool(new SearchToolContext(() -> null, null, null), mapService);
    }
    ...
    void guardLimitsCorpusToAnnotatedHexes() {
        ...
        GsimapSearchHexTool guarded =
                new GsimapSearchHexTool(new SearchToolContext(() -> null, null, null), mapService, 3);
    ...
    void guardKeepsTagOnlyHexesAndDropsEmptyHexes() {
        ...
        GsimapSearchHexTool guarded =
                new GsimapSearchHexTool(new SearchToolContext(() -> null, null, null), guardedMapService, 1);
    ...
    void turnDerivationWithWorldInformation() {
        ...
        GsimapSearchHexTool wiTool = new GsimapSearchHexTool(new SearchToolContext(() -> wi, null, null), mapService);
