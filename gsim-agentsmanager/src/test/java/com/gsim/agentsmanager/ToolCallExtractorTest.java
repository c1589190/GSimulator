...
class ToolCallExtractorTest {
    ...
    void pureJsonToolCall() {
        var result = ToolCallExtractor.extractFirstToolCall("{\"tool\":\"root_status\",\"args\":{}}");
    ...
    void fencedJsonToolCall() {
        var result = ToolCallExtractor.extractFirstToolCall("```json\n{\"tool\":\"root_status\",\"args\":{}}\n```");
        assertNotNull(result);
        assertEquals("root_status", result.tool());
    }
    ...
    void mixedChineseTextThenRawJson() {
        var result = ToolCallExtractor.extractFirstToolCall("让我先看看当前状态：\n\n{\"tool\":\"root_status\",\"args\":{}}");
    ...
    void textWithJsonMidSentence() {
        var result = ToolCallExtractor.extractFirstToolCall("让我先看看{\"tool\":\"root_status\",\"args\":{}}再决定怎么做。");
        assertNotNull(result);
        assertEquals("root_status", result.tool());
    }
