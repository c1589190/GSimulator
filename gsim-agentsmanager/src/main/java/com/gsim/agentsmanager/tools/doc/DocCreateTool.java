...
public final class DocCreateTool implements AgentTool {
    ...
    public Map<String, Object> getParameters() {
        return Map.of(
                ...
                "properties",
                        Map.of(
                                "docId", Map.of("type", "string", "description", "文档唯一 ID，仅字母数字连字符下划线"),
                                "type",
                                        Map.of(
                                                "type",
                                                "string",
                                                "description",
                                                "文档类型: character, skill, world_state, template, context, rule"),
        ...
        try {
            ...
            return ToolResult.ok(
                    ...
                    List.of(new ToolResult.Item(
                            title, docId, "已创建文档: type=" + type.key() + " id=" + docId + " v" + doc.version(), 1.0)));
        } catch (IOException e) {
