...
public record LlmMessage(
    ...
    public static LlmMessage assistant(String content, String reasoning) {
        return new LlmMessage(
                "assistant", content, null, null, null, reasoning != null && !reasoning.isEmpty() ? reasoning : null);
    }

    /** assistant 消息 + API 原生 tool_calls。 */
    public static LlmMessage assistantWithToolCalls(String content, List<LlmToolCall> toolCalls) {
        return new LlmMessage(
                "assistant", content, toolCalls != null ? List.copyOf(toolCalls) : null, null, null, null);
    }

    /** assistant 消息 + API 原生 tool_calls + reasoning_content。 */
    public static LlmMessage assistantWithToolCalls(String content, List<LlmToolCall> toolCalls, String reasoning) {
        return new LlmMessage(
                "assistant",
                content,
            ...
            for (Object item : tcList) {
                if (item instanceof java.util.Map<?, ?> tcMap) {
                    ...
                    java.util.Map<String, Object> fn =
                            (java.util.Map<String, Object>) ((java.util.Map<String, Object>) tcMap).get("function");
                    if (fn != null) {
                        ...
                        toolCalls.add(
                                new LlmToolCall(id != null ? id : "call_0", tcName != null ? tcName : "unknown", args));
                    }
                }
            }
        }
