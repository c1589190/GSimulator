...
public record ProviderConfig(
    ...
    /** 通用配置（不注入任何扩展参数）。 */
    public static ProviderConfig generic(
            String name, String baseUrl, String apiKey, String model, double temperature, int timeoutSeconds) {
        return new ProviderConfig(name, baseUrl, apiKey, model, temperature, timeoutSeconds, true, false, null, null);
    }
