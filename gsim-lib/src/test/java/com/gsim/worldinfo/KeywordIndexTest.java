        ...
        NodeSnapshot n0 = new NodeSnapshot(
                ...
                Map.of(
                        ...
                        new Checkpoint(
                                ...
                                "worldview",
                                List.of(new Element(
                                        "k0", "text", "中原大旱蝗灾四起", List.of("气候", "灾害"), List.of(), null, null)))),
                new LinkedHashMap<>());
        ...
        NodeSnapshot n0 = new NodeSnapshot(
                ...
                Map.of(
                        ...
                        new Checkpoint(
                                ...
                                List.of(
                                        new Element(
                                                "k1", "action", "曹操自陈留起兵", List.of("曹操", "军事"), List.of(), null, null),
                                        new Element(
                                                "k2",
                                                "action",
                                                "皇甫嵩固守长社",
        ...
        NodeSnapshot n0 = new NodeSnapshot(
                ...
                Map.of(
                        ...
                        new Checkpoint(
                                ...
                                "player",
                                List.of(new Element(
                                        "k1", "action", "some text", List.of("曹操", "军事"), List.of(), null, null)))),
                new LinkedHashMap<>());
        ...
        NodeSnapshot n0 = new NodeSnapshot(
                ...
                Map.of(
                        ...
                        new Checkpoint(
                                "p",
                                "player",
                                List.of(new Element("k1", "action", "hello world", List.of(), List.of(), null, null)))),
                new LinkedHashMap<>());
