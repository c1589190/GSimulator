...
class JsoupWebPageFetcherTest {
    ...
    void testFetch_HttpError() {
        ...
        assertThrows(IOException.class, () -> fetcher.fetch("http://localhost:" + server.getPort() + "/notfound"));
    }
    ...
    void testFetch_UnsupportedContentType() {
        ...
        assertThrows(IOException.class, () -> fetcher.fetch("http://localhost:" + server.getPort() + "/file.pdf"));
    }
    ...
    void testFetch_ContentTooLarge() {
        ...
        assertThrows(IOException.class, () -> fetcher.fetch("http://localhost:" + server.getPort() + "/large"));
    }
