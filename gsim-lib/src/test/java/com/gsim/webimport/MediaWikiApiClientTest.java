...
class MediaWikiApiClientTest {
    ...
    void setUp() throws Exception {
        ...
        server.start();
        apiClient =
                new MediaWikiApiClient("http://localhost:" + server.getPort() + "/api.php", 5, "GSimulatorTest/0.1");
    }
    ...
    void testGetPageByPageId() throws Exception {
        ...
        server.enqueue(
                new MockResponse().setResponseCode(200).setBody(json).addHeader("Content-Type", "application/json"));
