...
class UrlNormalizerTest {
    ...
    void testIsSameHost() {
        assertTrue(normalizer.isSameHost("https://example.com/page1", "https://example.com/page2"));
        assertTrue(normalizer.isSameHost("https://www.example.com/a", "https://example.com/b"));
        assertFalse(normalizer.isSameHost("https://example.com/page", "https://other.com/page"));
    }
