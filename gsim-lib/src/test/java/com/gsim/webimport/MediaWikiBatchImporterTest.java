...
class MediaWikiBatchImporterTest {
    ...
    void testImportAllPages() throws Exception {
        ...
        MediaWikiBatchImporter importer = new MediaWikiBatchImporter(
                apiClient, fileWriter, textExtractor, rateLimiter, "prts.wiki", "https://prts.wiki");

        MediaWikiBatchImporter.BatchImportResult result = importer.importAllPages("", 2, "prts/test");
    ...
    void testSkipExcludedPages() throws Exception {
        ...
        MediaWikiBatchImporter.BatchImportResult result = importer.importAllPages("", 5, "");
    ...
    void testMaxPagesLimit() throws Exception {
        ...
        MediaWikiBatchImporter.BatchImportResult result = importer.importAllPages("", 2, "");
