...
class ToolLoopNoToolReminderMentionsPlayerActionListForActionQueryTest {
    ...
    void playerActionQueryTriggersPlayerActionListHint() {
        ...
        assertTrue(
                reminder.contains("行动记录") || reminder.contains("玩家行动"),
                "Reminder for action query should mention 行动记录: " + reminder);
        assertTrue(reminder.contains("finish_action"), "Reminder must still mention finish_action");
    }
    ...
    void currentTurnActionQueryTriggersHint() {
        ...
        assertTrue(
                reminder.contains("行动") || reminder.contains("finish_action"),
    ...
    void listPlayerActionsQueryTriggersHint() {
        ...
        assertTrue(
                reminder.contains("玩家行动") || reminder.contains("行动"),
    ...
    void actionRecordQueryTriggersHint() {
        ...
        assertTrue(reminder.contains("行动记录"), "Action record query should trigger hint: " + reminder);
    }
    ...
    void englishPlayerActionQueryTriggersHint() {
        ...
        assertTrue(reminder.contains("行动记录"), "English 'player action' query should trigger hint: " + reminder);
    }
    ...
    void normalQueryDoesNotTriggerPlayerActionHint() {
        ...
        assertFalse(reminder.contains("行动记录"), "Normal settlement query should NOT trigger 行动记录 hint: " + reminder);
    }
