...
public class ApiRouter {
    ...
    public ApiRouter(
            ...
            boolean monitorMode,
            boolean cliMonitorHttpApi,
            AgentsManager agentsManager,
            AgentSseManager agentSseManager,
    ...
    /**
     * 注册所有 API 路由到 HttpServer。
     *
     * <p>注册的路由包括：
     * <ul>
     *   <li>基础接口（status、tools、help）</li>
     *   <li>命令与任务接口</li>
     *   <li>导入与文档管理</li>
     *   <li>World API v1/v2</li>
     *   <li>LLM Provider 管理</li>
     *   <li>缓存与搜索</li>
     *   <li>Agent 生命周期与配置管理</li>
     * </ul>
     *
     * <p>监控模式（monitorMode）下会禁用 Agent 对话相关路由。
     */
    public void registerAll() {
        ...
        if (monitorMode) {
            ...
            register("/api/command/stream", new StreamCommandHandler(ctx, eventBus, sessionManager, taskManager));
