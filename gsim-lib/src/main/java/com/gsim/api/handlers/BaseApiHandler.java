...
public final class BaseApiHandler {
    ...
    public static void addCorsHeaders(HttpExchange exchange) {
        ...
        exchange.getResponseHeaders()
                .set("Access-Control-Allow-Headers", "Content-Type, Authorization, X-GSim-Session-Id");
     ...
     * 发送 OK 响应带数据。
     */
    public static void sendOk(HttpExchange exchange, String message, java.util.Map<String, Object> data)
            throws IOException {
     ...
     * @param key      要解析的参数名称
     * @return 参数值，若不存在或查询字符串为空则返回 {@code null}
     */
     ...
     * @param text       要发送的文本内容
     * @throws IOException 若写入响应时发生 I/O 错误
     */
