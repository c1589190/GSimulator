...
public class WorldApiV2Handler implements HttpHandler {
    ...
    public WorldApiV2Handler(WorldManager wm, Path worldsDir) {
        this.wm = wm;
        this.cacheManager = new DocCacheManager(worldsDir.resolveSibling("docs").resolve(".cache"));
        try {
    ...
    private void route(HttpExchange exchange, String method, String[] segs) throws IOException {
        ...
        if (n == 1 && "DELETE".equals(method)) {
            ...
            OperationLog.get()
                    .record(segs[0], "world.delete", "DELETE", "/api/world/" + segs[0], "deleted", null, true);
            BaseApiHandler.sendOk(
                    exchange, "World deleted: " + segs[0], Map.of("worldId", segs[0], "action", "deleted"));
            return;
        }
        ...
        if (n == 2 && "nodes".equals(segs[1]) && "POST".equals(method)) {
            ...
            OperationLog.get()
                    .record(
                            ...
                            Map.of("nodeId", data.get("nodeId"), "parentId", parentId),
                            true);
        ...
        if (n == 4 && "GET".equals(method)) {
            ...
            if (truncateStr != null) {
                try {
                    truncate = Integer.parseInt(truncateStr);
        ...
        if (n == 5 && "POST".equals(method)) {
            ...
            boolean autoDoc = "true".equalsIgnoreCase(req.get("autoDoc") instanceof String s ? s : "");
            ...
            OperationLog.get()
                    .record(
                            ...
                            Map.of("ref", data.get("ref"), "action", data.get("action")),
                            true);
        ...
        if (n == 5 && "GET".equals(method)) {
            ...
            if (BaseApiHandler.isTextFormat(exchange)) {
                ...
                String raw = (String) data.getOrDefault("renderedContent", data.getOrDefault("value", ""));
