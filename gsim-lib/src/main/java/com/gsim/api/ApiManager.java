...
public class ApiManager {
     ...
     * 检查 HTTP 服务器是否已启动运行。
     *
     * @return 服务器已启动则返回 true，否则返回 false
     */
    public boolean isRunning() {
        return running;
    }

    public com.gsim.agent.management.AgentsManager getAgentsManager() {
        return agentsManager;
    }

    public com.gsim.agent.management.AgentSseManager getAgentSseManager() {
        return agentSseManager;
    }

    public com.gsim.agent.management.AgentCacheStore getAgentCacheStore() {
        return agentCacheStore;
    }

    public com.gsim.agent.config.AgentConfigManager getAgentConfigManager() {
        return agentConfigManager;
    }

    public com.gsim.llm.LlmConfigManager getLlmConfigManager() {
        return llmConfigManager;
    }

    public com.gsim.llm.LlmProviderRegistry getLlmRegistry() {
        return llmRegistry;
    }
     ...
     * 延迟注入 Agent 管理器。
     *
     * <p>由 GSimulatorApplication 在 wiring 完成后调用，必须在 start() 之前调用。
     *
     * @param agentsManager      Agent 管理器
     * @param agentSseManager    Agent SSE 事件管理器
     * @param agentCacheStore    Agent 缓存存储器
