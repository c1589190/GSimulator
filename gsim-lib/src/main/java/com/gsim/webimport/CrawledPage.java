...
public class CrawledPage {
     ...
     * @return 失败的 CrawledPage 实例
     */
    public static CrawledPage failed(String url, String errorMessage) {
        return builder(url).success(false).errorMessage(errorMessage).build();
    }
    ...
    public static class Builder {
        ...
        public Builder cleanedText(String v) {
            this.cleanedText = v;
            return this;
        }

        public Builder fetchedAt(Instant v) {
            this.fetchedAt = v;
            return this;
        }
        ...
        public Builder internalLinks(List<String> v) {
            this.internalLinks = v;
            return this;
        }

        public Builder crawlerName(String v) {
            this.crawlerName = v;
            return this;
        }
