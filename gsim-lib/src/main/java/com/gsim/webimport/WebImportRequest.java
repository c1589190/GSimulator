...
public class WebImportRequest {
    ...
    public boolean sameHostOnly() {
        return sameHostOnly;
    }

    public boolean wikiAllpages() {
        return wikiAllpages;
    }
    ...
    public static class Builder {
        ...
        public Builder fetchOnly(boolean v) {
            this.fetchOnly = v;
            return this;
        }

        public Builder crawlEnabled(boolean v) {
            this.crawlEnabled = v;
            return this;
        }
        ...
        public Builder delayMillis(long v) {
            this.delayMillis = v;
            return this;
        }
        ...
        public Builder maxBytesPerPage(long v) {
            this.maxBytesPerPage = v;
            return this;
        }
        ...
        public Builder sameHostOnly(boolean v) {
            this.sameHostOnly = v;
            return this;
        }

        public Builder wikiAllpages(boolean v) {
            this.wikiAllpages = v;
            return this;
        }

        public Builder wikiPrefix(String v) {
            this.wikiPrefix = v;
            return this;
        }

        public Builder outputSubdir(String v) {
            this.outputSubdir = v;
            return this;
        }

        /**
         * 构建 WebImportRequest 实例。
         *
         * @return 新的 WebImportRequest 对象
         */
