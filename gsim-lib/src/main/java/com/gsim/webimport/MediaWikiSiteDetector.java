...
public class MediaWikiSiteDetector {
     ...
     *
     * @param baseUrl 待检测站点的基础 URL
     * @return 检测结果，包含是否为 MediaWiki 及站点信息
     */
            ...
            try (Response response = client.newCall(request).execute()) {
                ...
                if (root.has("batchcomplete") || root.has("query")) {
                    ...
                    if (query != null && query.has("general")) {
                        ...
                        String siteName = general.has("sitename")
                                ? general.get("sitename").asText()
                                : "";
                        String generator = general.has("generator")
                                ? general.get("generator").asText()
                                : "";
     ...
     * 检测结果。
     */
    public record DetectionResult(boolean isMediaWiki, String apiUrl, String siteName, String generator) {
