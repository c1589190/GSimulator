...
class LogSanitizerMasksAuthorizationBearerTest {
    ...
    void maskAuthorizationHidesBearerToken() {
        ...
        assertTrue(result.contains("Authorization: Bearer ***"), "Should keep prefix but replace token: " + result);
        assertFalse(result.contains("sk-abc123def456"), "Token should be masked: " + result);
    }
    ...
    void lowercaseBearerTokenMasked() {
        ...
        assertTrue(result.contains("authorization: bearer ***"), "Case-insensitive match: " + result);
        assertFalse(result.contains("xyz-789"), "Token should be masked: " + result);
    }
    ...
    void bareBearerTokenMasked() {
        ...
        assertEquals("Token: Bearer ***", result, "Bare Bearer should be masked: " + result);
    }
    ...
    void cleanTextPreserved() {
        ...
        assertEquals(input, result, "Clean text should be unchanged");
    }
}
