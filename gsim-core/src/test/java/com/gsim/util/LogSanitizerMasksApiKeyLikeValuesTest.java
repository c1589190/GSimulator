...
class LogSanitizerMasksApiKeyLikeValuesTest {
    ...
    void apiKeyEqualsFormatMasked() {
        ...
        assertTrue(result.contains("api_key=***"), "Should mask value: " + result);
        assertFalse(result.contains("sk-secret-12345"), "Secret should be removed: " + result);
    }
    ...
    void apiKeyColonFormatMasked() {
        ...
        assertTrue(result.contains("api-key: ***"), "Should mask colon format: " + result);
        assertFalse(result.contains("abc-def-ghi"), "Secret should be removed: " + result);
    }
    ...
    void xApiKeyMasked() {
        ...
        assertTrue(result.contains("x-api-key: ***"), "Should mask x-api-key: " + result);
    }
    ...
    void jsonApiKeyMasked() {
        ...
        assertTrue(result.contains("\"apiKey\": \"***\""), "Should mask JSON apiKey value: " + result);
        assertFalse(result.contains("sk-json-secret"), "Secret should be removed: " + result);
    }
