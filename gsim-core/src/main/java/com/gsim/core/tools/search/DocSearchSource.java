 ...
 */
public final class DocSearchSource {

    private final SearchToolContext ctx;

    public DocSearchSource(SearchToolContext ctx) {
        this.ctx = ctx;
    }
     ...
     */
    public List<SearchEntry> build(String worldId, String effectiveNodeId, String typeParam, String tagParam) {
