package com.gsim.core.tools.doc;
...
public final class DocIndexTool implements AgentTool {
    ...
    public Map<String, Object> getParameters() {
        return Map.of(
                "type", "object",
                "properties", Map.of("docId", Map.of("type", "string", "description", "文档 ID")),
    ...
    public ToolResult execute(ToolCall call) {
        ...
        try {
            ...
            return ToolResult.ok(name(), List.of(new ToolResult.Item(doc.title(), docId, snippet, 1.0)));
        } catch (IOException e) {
