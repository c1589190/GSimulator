 ...
 */
public final class WorldSearchSource {

    private final SearchToolContext ctx;

    public WorldSearchSource(SearchToolContext ctx) {
        this.ctx = ctx;
    }
     ...
     * @return 搜索语料列表
     */
    public List<SearchEntry> build(String worldId, String effectiveNodeId, String checkpointId) {
