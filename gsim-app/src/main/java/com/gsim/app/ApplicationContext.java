...
public class ApplicationContext {
    ...
    public LlmProviderRegistry getLlmProviderRegistry() {
    ...
    public void setOnRootReadyCallback(Runnable callback) {
        this.onRootReadyCallback = callback;
    }
    ...
    public void setChatCommand(ChatCommand cc) {
        this.chatCommand = cc;
    }
    ...
    public void setWorldCommand(WorldCommand wc) {
    ...
    public void setNodeCommand(NodeCommand nc) {
        this.nodeCommand = nc;
    }

    public LlmCommand getLlmCommand() {
        return llmCommand;
    }

    public void setLlmCommand(LlmCommand lc) {
        this.llmCommand = lc;
    }
    ...
    public void setAgentCommand(AgentCommand ac) {
        this.agentCommand = ac;
    }

    public LocalFileSearchService getLocalFileSearchService() {
        return localFileSearchService;
    }
