...
class GsimapSearchRegionToolTest {
    ...
    void setUp() {
        ...
        tool = new GsimapSearchRegionTool(new SearchToolContext(() -> null, mapService, null, null));
    }
    ...
    void turnDerivationWithWorldInformation() {
        ...
        GsimapSearchRegionTool wiTool =
                new GsimapSearchRegionTool(new SearchToolContext(() -> wi, mapService, null, null));
