...
class WikiSearchToolTest {
    ...
    void setUp() throws Exception {
        ...
        Files.writeString(
                prtsDir.resolve("page-a-abc12345.txt"),
                """
                # 罗德岛
        ...
        Files.writeString(
                prtsDir.resolve("page-b-def67890.txt"),
                """
                # 年
        ...
        Files.writeString(
                prtsDir.resolve("page-c-ghi11111.txt"),
                """
                # 陨石事件
    ...
    void testMaxResults() {
        ToolCall call = new ToolCall("wiki_search", Map.of("keyword", "罗德岛", "max_results", "1"));
        ToolResult result = tool.execute(call);
