...
public class TaggedAgentProgressSink implements AgentProgressSink {
     ...
     */
    public TaggedAgentProgressSink(AgentProgressSink delegate, String agentId, String taskId, String sessionId) {
    ...
    public void onProgress(AgentProgressEvent event) {
        ...
        delegate.onProgress(
                new AgentProgressEvent(event.phase(), event.round(), event.maxRounds(), event.detail(), newMeta));
    }
}
