...
public final class DocTemplateTool implements AgentTool {
                        ...
                        Map.of(
                                ...
                                "template",
                                        Map.of(
                                                ...
                                                "string",
                                                "description",
                                                "模板文件名，如 world-template.md, input-template.md"),
                                "type",
                                        Map.of(
                                                "type",
                                                "string",
                                ...
                                "vars", Map.of("type", "string", "description", "JSON 格式变量表，如 {\"key\":\"value\"}")),
    ...
    public ToolResult execute(ToolCall call) {
        ...
        try (InputStream is = getClass().getClassLoader().getResourceAsStream(resourcePath)) {
            if (is == null) {
                return ToolResult.fail(name(), "模板不存在: " + templateName + "。可用模板在 resources/gsim/templates/ 下。");
            }
