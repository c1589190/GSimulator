package com.gsim.agent.tools.importing;
    ...
    public ToolResult execute(ToolCall call) {
        ...
        if (documentId.isBlank()) {
            return ToolResult.fail(
                    NAME, "documentId is required. Use import_document_list to find available documents.");
        }
        ...
        try {
            ...
            return ToolResult.ok(
                    NAME, List.of(new ToolResult.Item(result.displayName(), result.documentId(), sb.toString(), 1.0)));
